export default {
  ...
  auth: {
    ...
    inscription: {
      ...
      joinOurPlatform: "Treten Sie unserer Multi-Profil-Plattform bei",
      registrationSteps: "Registrierungsschritte",
      whyJoin: "Warum uns beitreten?",
      
      step1: {
        accountType: "Kontotyp",
        selectProfile: "Wählen Sie das Profil, das Ihren Bedürfnissen entspricht",
        shortDescription: "Wählen Sie Ihren Kontotyp",
        stagiaire: {
          description: "Sonderzugang für Studenten und Praktikanten mit pädagogischer Betreuung",
          price: "Ab {{price}}€/Monat",
          feature1: "Ausbildung & Lernen"
        },
        candidat: {
          description: "Suchen Sie nach Jobmöglichkeiten mit unseren fortschrittlichen Tools",
          price: "Ab {{price}}€/Monat",
          feature1: "Jobsuche"
        },
        particulier: {
          description: "Persönlicher Bereich für Ihre täglichen Einkäufe mit exklusiven Vorteilen",
          price: "Ab {{price}}€/Monat",
          feature1: "Persönliches Einkaufen"
        },
        freelance: {
          description: "Arbeiten Sie unabhängig mit unseren professionellen Tools",
          price: "Ab {{price}}€/Monat",
          feature1: "Unabhängige Arbeit"
        },
        professionnel: {
          description: "Geschäftsbereich mit Teamverwaltung und kollaborativen Tools",
          price: "Ab {{price}}€/Monat",
          feature1: "Unternehmensverwaltung"
        },
        partenaire: {
          description: "Verkaufen Sie Ihre Produkte auf unserer Plattform mit Marketing-Tools",
          price: "Ab {{price}}€/Monat",
          feature1: "Verkauf & E-Commerce"
        },
        administrateur: {
          description: "Teammitglied mit vollem Zugriff (nach Validierung)",
          price: "Nach Validierung",
          feature1: "Administration"
        }
      },
      
      step2: {
        subtitle: "Geben Sie Ihre persönlichen Informationen ein",
        shortDescription: "Persönliche Informationen"
      },
      
      step3: {
        subtitle: "Erstellen Sie ein sicheres Passwort",
        shortDescription: "Kontosicherheit"
      }
    },
    userType: {
