export default {
  ...
  auth: {
    ...
    inscription: {
      ...
      joinOurPlatform: "Sluit u aan bij ons multi-profielplatform",
      registrationSteps: "Registratiestappen",
      whyJoin: "Waarom bij ons aansluiten?",
      
      step1: {
        accountType: "Accounttype",
        selectProfile: "Kies het profiel dat bij uw behoeften past",
        shortDescription: "Selecteer uw accounttype",
        stagiaire: {
          description: "Speciale toegang voor studenten en stagiairs met educatieve begeleiding",
          price: "Vanaf {{price}}€/maand",
          feature1: "Training & Leren"
        },
        candidat: {
          description: "Zoek naar kansen met onze geavanceerde tools",
          price: "Vanaf {{price}}€/maand",
          feature1: "Werk zoeken"
        },
        particulier: {
          description: "Persoonlijke ruimte voor uw dagelijkse aankopen met exclusieve voordelen",
          price: "Vanaf {{price}}€/maand",
          feature1: "Persoonlijk winkelen"
        },
        freelance: {
          description: "Werk onafhankelijk met onze professionele tools",
          price: "Vanaf {{price}}€/maand",
          feature1: "Onafhankelijk werk"
        },
        professionnel: {
          description: "Bedrijfsruimte met teambeheer en samenwerkings tools",
          price: "Vanaf {{price}}€/maand",
          feature1: "Bedrijfsbeheer"
        },
        partenaire: {
          description: "Verkoop uw producten op ons platform met marketing tools",
          price: "Vanaf {{price}}€/maand",
          feature1: "Verkoop & E-commerce"
        },
        administrateur: {
          description: "Teamlid met volledige toegang (op validatie)",
          price: "Op validatie",
          feature1: "Administratie"
        }
      },
      
      step2: {
        subtitle: "Voer uw persoonlijke informatie in",
        shortDescription: "Persoonlijke informatie"
      },
      
      step3: {
        subtitle: "Maak een veilig wachtwoord aan",
        shortDescription: "Accountbeveiliging"
      }
    },
    userType: {
      stagiaire: 'Stagiair',
