export default {
  ...
  auth: {
    ...
    inscription: {
      createYourAccount: "Sama jàngale bi",
      joinOurPlatform: "Bokk ci sunu palatofórm bu jëmm-jiitu",
      registrationSteps: "Wërii jàngale bi",
      whyJoin: "Nanga la bokk?",
      
      step1: {
        accountType: "Cosaan jàngale bi",
        selectProfile: "Tann jëmm biy man a ànd ak say soxla",
        shortDescription: "Tann sa cosaan jàngale bi",
        stagiaire: {
          description: "Jëmm bu sopp bu am solo ñeel taalibe yi ak stagiaire yi ak jàppale pedagoogik",
          price: "Ci {{price}}€/wërs",
          feature1: "Jàngale ak Jàng"
        },
        candidat: {
          description: "Wër jëfandikoo yu bees ak sunu jumtukaay yu kawe",
          price: "Ci {{price}}€/wërs",
          feature1: "Wër liggéey"
        },
        particulier: {
          description: "Kaw bu am solo ñeel say jëfandikoo yu bés ak njariñ yu sopp",
          price: "Ci {{price}}€/wërs",
          feature1: "Jëfandikoo bu am solo"
        },
        freelance: {
          description: "Liggéeyal sa bopp ak sunu jumtukaay yu jëm kan",
          price: "Ci {{price}}€/wërs",
          feature1: "Liggéey bu temb"
        },
        professionnel: {
          description: "Kaw bu liggéey bi ak jooyu wàllu team ak jumtukaayu warkat",
          price: "Ci {{price}}€/wërs",
          feature1: "Jooyu wàllu liggéey"
        },
        partenaire: {
          description: "Jàll say product ci sunu palatofórm ak jumtukaayu marketing",
          price: "Ci {{price}}€/wërs",
          feature1: "Jàll ak E-commerce"
        },
        administrateur: {
          description: "Cosaan wàllu team biy am jëmm bu mat (ci settantal)",
          price: "Ci settantal",
          feature1: "Wàllu admin"
        }
      },
      
      step2: {
        subtitle: "Bind sa xibaar bu am solo",
        shortDescription: "Xibaar bu am solo"
      },
      
      step3: {
        subtitle: "Sama baatu wér bu am kaaraange",
        shortDescription: "Kaaraange jàngale bi"
      }
    },
    userType: {
      stagiaire: 'Stagiaire',
